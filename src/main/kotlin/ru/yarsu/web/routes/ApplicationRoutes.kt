...
import ru.yarsu.web.routes.v1.GetListOfSWGHandler
...
fun applicationRoutes(
    ...
    val swgListHandler = GetListOfSWGHandler(GetListOfSWGOperation(swgStorage), mapper)
    val newSwgHandler =
        NewSwgHandler(NewSwgOperation(swgStorage, dumpTruckStorage, usersStorage), dumpTruckStorage, usersStorage)
    val swgInfoHandler = SwgInfoHandler(swgStorage, dumpTruckStorage, usersStorage)
